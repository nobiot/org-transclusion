...
- Book writing ::
  ...
  You have a collection of notes. You can quickly transclude paragraphs and sections from them into a draft. As they are links, it's easy to re-organize them into different sequences to see which way works the best. 
