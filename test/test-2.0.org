...
* Regression
** Translclude from same buffer

   #+transclude: [[id:2026-03-07T124245]]
...
** info
   ...
   #+transclude: [[info:elisp#Buffer Display Action Functions][(elisp) Buffer Display Action Functions]]
...
** defun / sexp (thingatpt)

   #+transclude: [[file:~/src/org-transclusion/org-transclusion-font-lock.el::(defun org-transclusion-font-lock-set]]  :src emacs-lisp :thingatpt sexp

   [[orgit-rev:~/src/org-transclusion/::0737cfeb0a51fe2143c9cbcbb8d7d0664e3d2a1e][~/src/org-transclusion/ (magit-rev 0737cfe)]]

[[file:~/src/org-transclusion/org-transclusion-font-lock.el::(defun org-transclusion-font-lock-set]]
   [[orgit-file:~/src/org-transclusion/::0737cfe::org-transclusion.el::org-transclusion-new-function]]
...
*** Example
   ...
   #+transclude: [[orgit-file:~/src/org-transclusion/::8ec0233::org-transclusion.el::org-transclusion-new-function][org-transclusion-new-function (83c0233)]]  :src emacs-lisp :thingatpt sexp
...
** test text
   ...
   ::/regexp/ does not work as intended because it will open an occur buffer and
