...
This transclude all the rows
#+transclude: [[file:org-table-rows.org::barz]]

Currently, this always removes the third row only no matter what value you add to :table-rows property
#+transclude: [[file:org-table-rows.org::barz]] :table-rows 1-2
...
#+transclude: [[file:paragraph.org::table-with-link][Link to a table with a link]] :table-rows 1-2
