...
*NOTICE* Please refer to notice on the upcoming changes and new features in [issue 81](https://github.com/nobiot/org-transclusion/issues/81) -- it includes a minor breaking change. 
